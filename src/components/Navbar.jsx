    ...
    <div className="absolute top-0 left-0 w-full z-10">
      <div className="container mx-auto flex justify-between items-center py-4 px-6  gap-5 text-white md:px-20 lg:px-32 bg-transparent">
       <img src={assets.lg}  alt="" className="h-12" />
        ...
        {/* <button className="hidden border md:block  p-3 text-white rounded-full">
          Signup
        </button> */}
      ...
      {/* --------mobile menu-------- */}
      <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0'}  right-0 top-0 overflow-hidden h-full bg-[#855e42] transition-all`}>
